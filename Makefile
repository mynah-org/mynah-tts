...
CORE_SOURCES := src/mynah_tts.c src/weights.c src/mynah_util.c src/graph.c src/kernels.c src/audio.c src/backend.c src/threads.c src/qmat.c src/tokenizer.c src/tokenizer_sentencepiece.c
