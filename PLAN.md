...
- [ ] E15-26 Pocket 24L CPU serving on Axion: first 10-min screens (16x2 mb8) show a ~69 audio-s/s ceiling (0.44x the 6L), C48 RTF p95 0.746 but TTFA p95 670 ms and 18 stalls@500 from long-text prefill; 4x8 is 2x worse. Understand prefill cap/T_frame for 24L and find the operating point → [`.work/pocket-tts-24l-cpu-serving-axion.md`](.work/pocket-tts-24l-cpu-serving-axion.md)
